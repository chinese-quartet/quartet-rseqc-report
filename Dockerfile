...
RUN /opt/conda/bin/mamba create -n venv -c r -c free -c main -c defaults -c conda-forge -c bioconda -y python=3.9 r-renv r-base=3.6.3 hisat2==2.2.1 samtools==1.14 htslib==1.14 bioconductor-ballgown==2.18.0 bioconductor-genefilter==1.68.0 qualimap==2.2.2d fastq-screen==0.15.2 fastqc==0.11.9 fastp==0.23.2 stringtie==2.2.1
